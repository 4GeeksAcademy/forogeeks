...
export default function FLAME({ size = 24, color = "currentColor" }) {
    return (
        <svg fill={color} height={size} width={size} version="1.1" viewBox="0 0 611.999 611.999" preserveAspectRatio="xMidYMid meet">
